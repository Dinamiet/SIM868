...
{
	SIM868_GSM_RESPONSE_FUNC           = 0x3C05AEFF, // CFUN
	SIM868_GSM_RESPONSE_PIN            = 0x754EDBE9, // CPIN
	SIM868_GSM_RESPONSE_NETWORKCHANGE  = 0xC8DDE4F3, // CREG
	SIM868_GSM_RESPONSE_SIGNAL_QUALITY = 0x78219D86, // CSQ
} SIM868GSMResponse;
